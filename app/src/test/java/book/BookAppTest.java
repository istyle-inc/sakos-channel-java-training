...
public class BookAppTest {
    ...
    class シチュエーション1のテスト_1 {
        ...
        public void 追加する本が空の場合_入力したリストをそのまま返すこと() {
            ...
            var books = List.of(new Book("タイトル1", "著者1"), new Book("タイトル2", "著者2"));
            // Exercise
            var actual = sut.addBookWithoutDuplicateFor(books);
            // Test
            assertThat(actual)
                    .anyMatch(book -> book.title() == "タイトル1" && book.author() == "著者1")
                    .anyMatch(book -> book.title() == "タイトル2" && book.author() == "著者2")
        ...
        public void 追加する本と初期状態の本に重複がない場合_入力したリストに追加する本をそのまま追加すること() {
            ...
            var books = List.of(new Book("タイトル1", "著者1"), new Book("タイトル2", "著者2"));
            // Exercise
            var actual = sut.addBookWithoutDuplicateFor(books, new Book("タイトル3", "著者2"));
            // Test
            System.out.println(actual);
            assertThat(actual)
                    .anyMatch(book -> book.title() == "タイトル1" && book.author() == "著者1")
        ...
        public void 追加する本と初期状態の本に重複がある場合_入力したリストに追加する本を重複を省いて追加すること() {
            ...
            var books = List.of(new Book("タイトル1", "著者1"), new Book("タイトル2", "著者2"));
            // Exercise
            var actual = sut.addBookWithoutDuplicateFor(books, new Book("タイトル2", "著者2"), new Book("タイトル3", "著者3"));
            // Test
            System.out.println(actual);
            assertThat(actual)
                    .anyMatch(book -> book.title() == "タイトル1" && book.author() == "著者1")
        ...
        public void 重複を省いた結果何も残らなかった場合_入力したリストをそのまま出力すること() {
            ...
            var books = List.of(new Book("タイトル1", "著者1"), new Book("タイトル2", "著者2"));
            // Exercise
            var actual = sut.addBookWithoutDuplicateFor(books, new Book("タイトル2", "著者2"), new Book("タイトル1", "著者1"));
            // Test
            System.out.println(actual);
            assertThat(actual)
                    .anyMatch(book -> book.title() == "タイトル1" && book.author() == "著者1")
        ...
        public void 追加する本の中で重複がある場合_入力したリストに追加する本を重複を省いて追加すること() {
            ...
            var books = List.of(new Book("タイトル1", "著者1"), new Book("タイトル2", "著者2"));
            // Exercise
            var actual = sut.addBookWithoutDuplicateFor(books, new Book("タイトル3", "著者3"), new Book("タイトル3", "著者3"));
            // Test
            System.out.println(actual);
            assertThat(actual)
                    .anyMatch(book -> book.title() == "タイトル1" && book.author() == "著者1")
    ...
    class シチュエーション1のテスト_2 {
        ...
        public void 追加する本が空の場合_入力したリストをそのまま返すこと() {
            ...
            var books = List.of(new Book("タイトル1", "著者1"), new Book("タイトル2", "著者2"));
            // Exercise
            var actual = sut.addBookWithoutDuplicateFor2(books);
            // Test
            assertThat(actual)
                    .anyMatch(book -> book.title() == "タイトル1" && book.author() == "著者1")
                    .anyMatch(book -> book.title() == "タイトル2" && book.author() == "著者2")
        ...
        public void 追加する本と初期状態の本に重複がない場合_入力したリストに追加する本をそのまま追加すること() {
            ...
            var books = List.of(new Book("タイトル1", "著者1"), new Book("タイトル2", "著者2"));
            // Exercise
            var actual = sut.addBookWithoutDuplicateFor2(books, new Book("タイトル3", "著者2"));
            // Test
            System.out.println(actual);
            assertThat(actual)
                    .anyMatch(book -> book.title() == "タイトル1" && book.author() == "著者1")
        ...
        public void 追加する本と初期状態の本に重複がある場合_入力したリストに追加する本を重複を省いて追加すること() {
            ...
            var books = List.of(new Book("タイトル1", "著者1"), new Book("タイトル2", "著者2"));
            // Exercise
            var actual = sut.addBookWithoutDuplicateFor2(books, new Book("タイトル2", "著者2"), new Book("タイトル3", "著者3"));
            // Test
            System.out.println(actual);
            assertThat(actual)
                    .anyMatch(book -> book.title() == "タイトル1" && book.author() == "著者1")
        ...
        public void 重複を省いた結果何も残らなかった場合_入力したリストをそのまま出力すること() {
            ...
            var books = List.of(new Book("タイトル1", "著者1"), new Book("タイトル2", "著者2"));
            // Exercise
            var actual = sut.addBookWithoutDuplicateFor2(books, new Book("タイトル2", "著者2"), new Book("タイトル1", "著者1"));
            // Test
            System.out.println(actual);
            assertThat(actual)
                    .anyMatch(book -> book.title() == "タイトル1" && book.author() == "著者1")
        ...
        public void 追加する本の中で重複がある場合_入力したリストに追加する本を重複を省いて追加すること() {
            ...
            var books = List.of(new Book("タイトル1", "著者1"), new Book("タイトル2", "著者2"));
            // Exercise
            var actual = sut.addBookWithoutDuplicateFor2(books, new Book("タイトル3", "著者3"), new Book("タイトル3", "著者3"));
            // Test
            System.out.println(actual);
            assertThat(actual)
                    .anyMatch(book -> book.title() == "タイトル1" && book.author() == "著者1")
